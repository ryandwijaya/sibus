   ...
   <div class="row">
   		...
   		<div class="col-md-10 border text-left">
			...
			<div class="row text-left">
				...
				<a href="" class="kursi" data-href="<?= base_url() ?>beli_admin" data-title="<?= $i ?>" data-toggle="modal" data-target="#confirm-delete">
					<b><?= $i; ?></b>
				</a>
				<?php }else{?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					<?php 
					$tujuan = $this->Tujuan->getTujuanById($_POST['tiket_tujuan']) ?>
					<label for="">Tujuan ( <b><?= $tujuan['tujuan_lokasi'] ?></b> )</label>
					<input type="text" class="form-control" title="id Tujuan" readonly name="tiket_tujuan" value="<?= $_POST['tiket_tujuan'] ?>">
				</div>
				<div class="form-group">
					<label for="">Harga Tiket <b><span id="diskon">Diskon (<?= $jadwal['jadwal_markup'] ?> %)</span></b></label>
					<?php 
					$harga = $tujuan['tujuan_harga'];
					$diskon = $harga*$jadwal['jadwal_markup']/100;
					$total  = $harga - $diskon;
					 ?>
					<input type="text" class="form-control" id="harga" readonly name="tiket_total_bayar" value="<?= $total ?>">
				</div>
